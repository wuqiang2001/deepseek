    ...
    >
      <div>
        ...
        >
          ...
          >
            ...
            <div
              ...
              } opacity-0 group-hover:opacity-100 transition bg-black text-white text-sm px-3 py-2 rounded-lg pointer-events-none`}
            >
              {expand ? "关闭侧边栏" : "打开侧边栏"}
              <div
        ...
        >
          ...
          {expand && <p className="text-white text font-medium">新建对话</p>}
        </button>
        ...
        >
          ...
          >
            <div className="relative w-max bg-black text-white text-sm p-3 rounded-lg shadow-lg">
              ...
              <p>扫码以获取DeepSeek App</p>
              <div
                className={`w-3 h-3 absolute bg-black rotate-45 ${
                  expand ? "right-12" : "left-4"
                } -bottom-1.5`}
              ></div>
            </div>
          </div>
